...
#define IS_IOS9 (NSFoundationVersionNumber >= NSFoundationVersionNumber_iOS_9_0)
#define IS_IOS10 (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_9_x_Max)
